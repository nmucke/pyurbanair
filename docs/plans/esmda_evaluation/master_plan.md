...
| 2.1 | Persist obs + per-iteration predicted obs / params | [phase2](phase2_obs_persistence.md) | S | in review | — |
| 2.2 | `O_N` vs ½ + figure D3 | [phase2](phase2_obs_persistence.md) | S | in review | — |
