...
|---|---|---|---|---|---|
| 0.1 | Fair CRPS / energy-score estimators + CRPSS vs prior + `metrics_version` | [phase0](phase0_correctness_fixes.md) | S | in review | [#96](https://github.com/nmucke/pyurbanair/pull/96) |
| 0.2 | Spread–skill: RMS-of-variances + Fortin factor (callers updated) | [phase0](phase0_correctness_fixes.md) | S | in review | [#96](https://github.com/nmucke/pyurbanair/pull/96) |
| 0.3 | Duplicate-member guard (`ensemble_health`) | [phase0](phase0_correctness_fixes.md) | S | in review | [#96](https://github.com/nmucke/pyurbanair/pull/96) |
