...
axis instead of signed distance to a (non-existent) wall.
\end{itemize}
...
$(N_z/r)\times(N_y/r)\times(N_x/r)$, and let $\mathcal P_H$ be the matching
...
$\bm e_i$ ($n_{\text{pos}}$ channels, signed distance to the global boundary on
non-periodic axes and a periodic $\sin$ signal otherwise). The shared fine network
