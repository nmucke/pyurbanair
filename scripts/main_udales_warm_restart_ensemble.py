...
ENSEMBLE_SIZE = 3
RESULTS_DIR = ".temp/udales_ensemble"
...
def main() -> None:
    ...
    pressure_gradient_magnitude_range = jnp.ones(ENSEMBLE_SIZE) * 0.0041912
    ...
    params_ensemble = xarray.Dataset(
        data_vars={
            ...
            "pressure_gradient_magnitude": (
                "ensemble",
                pressure_gradient_magnitude_range,
            ),
        },
    ...
    ensemble_forward_model.from_warm_start = True
    state = ensemble_forward_model.run_ensemble(params=params_ensemble)
