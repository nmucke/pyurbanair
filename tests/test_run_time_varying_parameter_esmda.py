...
def test_run_time_varying_parameter_esmda(
    ...
    """Spin-up path: time-varying parameter ESMDA writes the assim states
    under out_dir/assim_states; the cfg.run.results_dir override is no
    longer plumbed through, so no on-disk/in-memory axis here."""
