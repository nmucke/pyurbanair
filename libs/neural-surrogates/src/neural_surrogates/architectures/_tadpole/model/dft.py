...
# {"frozen", "FPFT"}, so this import is never exercised. Keep it optional so the
# vendored module imports without the (unvendored) GIFt dependency; a genuine
# int-rank request then fails loud below with an actionable message. (Mirrors the
# identical shim in ``model/autoencoder.py``.)
