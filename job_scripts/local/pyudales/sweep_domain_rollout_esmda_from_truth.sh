#!/bin/bash
# Thin wrapper: LOCAL sweep over grid resolution (NX/NY/NZ) for the pyudales backend.
#
...
#
#     bash job_scripts/local/pyudales/sweep_domain_rollout_esmda_from_truth.sh esmda.seed=1
set -euo pipefail
