#!/bin/bash
# Thin wrapper: DELFTBLUE sweep over grid resolution (NX/NY/NZ) for the pyudales backend.
#
...
#
#     bash job_scripts/delftblue/pyudales/sweep_domain_rollout_esmda_from_truth.sh esmda.seed=1
set -euo pipefail
