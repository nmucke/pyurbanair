#!/bin/bash
# Thin wrapper: SNELLIUS sweep over grid resolution (NX/NY/NZ) for the pyudales backend.
#
...
#
#     bash job_scripts/snellius/pyudales/sweep_domain_rollout_esmda_from_truth.sh esmda.seed=1
set -euo pipefail
