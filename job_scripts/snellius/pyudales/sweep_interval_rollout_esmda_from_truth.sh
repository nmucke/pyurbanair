#!/bin/bash
# Thin wrapper: SNELLIUS sweep over the observation interval (esmda.interval_seconds,
...
#
#     bash job_scripts/snellius/pyudales/sweep_interval_rollout_esmda_from_truth.sh
#
# Any extra arguments are forwarded as Hydra overrides to EVERY job, e.g.:
#
#     bash job_scripts/snellius/pyudales/sweep_interval_rollout_esmda_from_truth.sh esmda.seed=1
set -euo pipefail
